...
void Client_UI::createConnections()
{
    ...
    connect(client_thread, SIGNAL(toDiePreAge(double)), this, SLOT(updateMaxDieAge(double)));
    ...
    connect(client_thread, SIGNAL(toDieHerAge(double)), this, SLOT(updateMaxDieAge(double)));
}
